 ...
 */
	...
	function changeName(){
		$("h2").text("Debra Knight");
	}

	$("#button1").click(changeName);
 ...
 */
 	...
 	$("#button2").click(backgroundPink);

/**
 * Question 5:
 * When button 2 is clicked, change the color of all h2's to "green"
 */
 	function greenHeadline(){
 		$("h2").css("color", "green");
 	}

 	$("#button2").click(greenHeadline);
...
//Change photo content to new photo

	function newPhoto(){
		$(".city").attr("src", "http//lorempixel.com/g/500/400/food");
	}

	$("#button3").click(newPhoto);
 ...
 */
 	...
 	function newFontColor(){
 		$("p").css({color: "purple", fontFamily: "Georgia"});
 	}

 	$("#button3").click(newFontColor);
